...
### &emsp;iOS app
- На iOS клавиатура перекрывает поле ввода. Отображаеться нормально после сворачивания и разворачивания приложения (фикс - частичный (v1.1))
- На iOS версиях приложения замечены белые полосы сверху и снизу приложения. Проверено на iPhone 13 (фикс - частичный (v1.1))
